...
TEST_F(H264PredWeightTableParserTest, TestSamplePredWeightTable2) {
  ...
  const uint8_t buffer[] = {
      0x91, 0x6d, 0x6d, 0x6a, 0x74, 0x69, 0x6d, 0x1b,
      0x4a, 0xc9, 0x94, 0xc0, 0x00, 0x00, 0x00, 0xaf,
      0xff, 0x22, 0x99, 0xae, 0xc6, 0x58, 0x42, 0x89,
      0x35, 0x86, 0x40, 0x23
};
  ...
  EXPECT_EQ(3, pred_weight_table->chroma_log2_weight_denom);
  EXPECT_THAT(
